...
## Data Info
List of all fires since 2019 generated by https://github.com/dominiktraxl/firetracks/tree/master
### USA & CAN & 2025
1. FIRMS
    - USA & Canada
2. HRRR
    - HRRR is USA Only
    - Canadian Product:
        - ECMWF - IFS operational product
3. MODIS
    - US & Canada
4. ESI
    - Worldwide
5. RAVE
    - CONUS only 2019 & 2020
    - Total Range:
        - 2019-07-01 -> 2023-12-31
        - GAP: 2021-01-01 -> 2024-09-19
        - 2024-09-20 -> Current
...
1. Generate incident dataset for each fire based on combo of FIRMS data & MTBS. 
    ...
    - Used library and MODIS data - downside no names...
2. Train basic ML model and evaluate over dry run + fires
    - Expand model architectures and compare performances
    - feature importance weighting
3. Create a dashboard with stats about each fire and maps of different layers
...
## Next ML Steps 3-11-26
* Look into timeseries of interesting fires in test data to check the behavior of the model
* Add features for GOES-5 satelite: precip, T, Wind Speed, snow depth
* Add slope information
* Add fuel loading features
* explore different model types
* continue building the dataset
* expand to two-day prediction
* stratify by magnitude of FRP growth
* compare to persistence
* evaluate under/over-prediction

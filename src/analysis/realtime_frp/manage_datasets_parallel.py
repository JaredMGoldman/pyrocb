...
# collect data from RRFS, RAVE, ESI, ELEVATION, ABI, for next two days for each small fire
#       would be nice to handle all fires for a given day at once per data 
#       source to avoid too much work downloading
#       only for the next two days so it could be easier than I think?
# generate features for the given model (maybe within the model class)?

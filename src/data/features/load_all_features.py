...
args_dict_weighting = {
    ...
    'hdw' : {
        ...
        'hrrr_data_root' : '/data/lthapa/data2restore/lthapa'},
    'hdw500' : {
    ...
    'hwp' : {
        'func' : hwp_timeseries,
        'hrrr_data_root' : '/data2/lthapa/ML_daily/pygraf/processed_hrrr_hdw_hwp'},
    'loading' : {
        'func' : fuel_loading_timeseries,
        'fuel_fwi_data' : '/data/lthapa/data2restore/lthapa/ML_daily/fuel_fwi_990m.nc'},
    'ncar' : {
        'func' : ncar_timeseries,
        'data_root' : '/data/lthapa/data2restore/lthapa'},
    'population' : {
        'func' : pop_timeseries,
        'pop_data' : '/data/lthapa/data2restore/lthapa/static_maps/gpw_v4_population_density_rev11_2pt5_min.nc' },
    'pws' : {
        'func' : pws_timeseries,
    ...
    'slope' : {
        ...
        'slope_data' : '/data2/lthapa/ML_daily/slope_990m_LF2020.nc'},
    'smops' : {
...
if __name__ == "__main__":
    ...
    for year in years:    
        ...
        for irwin_id in irwinIDs:
            ...
            if year==2021:
                structures_all.columns = ['REPORT_FROM_DATE','REPORT_TO_DATE','IRWIN_IDENTIFIER','QTY_DESTROYED','QTY_DAMAGED','QTY_THREATENED_72']
            else:
                structures_all.columns = ['REPORT_FROM_DATE','REPORT_TO_DATE','PCT_CONTAINED_COMPLETED',
            ...
            for k, v in heatwave_dict.items():
                feature = heatwave_timeseries(df_fire, **v)
            ...
            for k, v in args_dict_weighting.items():
                ...
                my_func = v.pop('func')
                feature_weighted, feature_unweighted = my_func(df_fire, **v)

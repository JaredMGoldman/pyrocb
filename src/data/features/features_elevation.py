...
def elevation_timeseries(df, path_elevation = '/data/lthapa/data2restore/lthapa/ML_daily/elev_990m_LF2020.nc'):
    fire_elevation_intersection_xr = parallel_intersection_labels(df, 'ELEV_GRID_990M')
